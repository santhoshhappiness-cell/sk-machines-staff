...
#       not handle the case statement, edit this file and set the shell variable
#       'SHELL' to 'bash' or 'ksh' and re-execute.
#
#   (2) The trailing newline in this file is important for running on Windows
#       using Git Bash.
#
##############################################################################
